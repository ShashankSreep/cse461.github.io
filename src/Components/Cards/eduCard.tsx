export function EduCard() {
    return (
        <div className="bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-700 flex flex-col gap-3">
            <h3 className="text-xl text-white mb">
            ...
            >
                ...
                <svg
                    ...
                    strokeWidth={2}
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4H9l3-3 3 3h-2v4zM5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            </a>
            <a
